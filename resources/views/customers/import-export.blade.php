                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white shadow-md p-6 rounded-lg">
                            <h3 class="text-xl font-semibold mb-4">Import Customers</h3>
                            <form action="{{ route('customers.import') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mt-4">
                                    ...
                                    <ul class="list-disc ml-6">
                                        <li><a href="{{ asset('assets/sample/customers.csv') }}" class="text-blue-500">Download CSV Sample</a></li>
                                        <li><a href="{{ asset('assets/sample/customers.xlsx') }}" class="text-blue-500">Download Excel Sample</a></li>
                                    </ul>
                                </div>
                            </form>
                        </div>
                        ...
                        <!-- Export Section -->
                        <div class="bg-white shadow-md p-6 rounded-lg">
                            <h3 class="text-xl font-semibold mb-4">Export Customers</h3>
